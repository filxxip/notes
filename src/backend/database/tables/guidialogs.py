...
@set_conversion(releaseDate=convert_str_date_to_datetime, isOk =convert_str_to_bool, isAbort =convert_str_to_bool,isYes = convert_str_to_bool,isNo = convert_str_to_bool )
class GuiDialog(Base):
    __tablename__ = "GuiDialogs"
